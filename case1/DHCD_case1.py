...
data_path_test ='D:/1Dataset/DevanagariHandwrittenCharacterDataset/Test'
...
# Split the dataset
x_val, x_test, y_val, y_test = train_test_split(x, y, test_size=0.2, random_state=2)
...
plt.xlabel('Epoch')
plt.ylabel('Accuracy')
plt.title('Model - Accuracy; train= 78200, val= 11040, test= 2760')
